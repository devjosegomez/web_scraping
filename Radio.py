...
class RadioSpider(scrapy.Spider):
    name = 'Radio'
    allowed_domains = ['radioshack.com.mx']
    start_urls = ['https://www.radioshack.com.mx/store/radioshack/en/Categor%C3%ADa/c/ROOT?q=%3Aprice-asc&page=0']
...
##        next_page_url = "https://www.officedepot.com.mx/officedepot/en/Categor%C3%ADa/Todas/c/0-0-0-0?q=a%3AtopRated&page=89"
